 ...
 * @author Admin
 */
public class FormNhomKhachHang extends javax.swing.JFrame {
     ...
     */
    public FormNhomKhachHang() throws ClassNotFoundException, SQLException {
        initComponents();
        loadDuLieuLenLuoi();
    ...
    private void loadDuLieuLenLuoi() throws ClassNotFoundException, SQLException {
        ...
        //tạo cột
        tableModel.addColumn("Customer Type No.");
        ...
        List<NhomKhachHang> nhomKhachHangList = nhomKhachHangDAO.selectAll();
        for (NhomKhachHang nkh : nhomKhachHangList) {
            Vector vector = new Vector();
            vector.add(nkh.getMaNhomKH());
            vector.add(nkh.getTenNhomKH());
    ...
    private void initComponents() {
        ...
        txt_TenNKH = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        txt_Ma_NKH = new javax.swing.JTextField();
        jPanel3 = new javax.swing.JPanel();
        jLabel12 = new javax.swing.JLabel();
        txt_Search_Ma_NKH = new javax.swing.JTextField();
        jLabel13 = new javax.swing.JLabel();
        txt_Search_Ten_NKH = new javax.swing.JTextField();
        btnTimKiem = new javax.swing.JButton();
        btn_Search_Clear = new javax.swing.JButton();
        lbl_MaNKH_Search_Hint = new javax.swing.JLabel();
        jLabel18 = new javax.swing.JLabel();
        lbl_Cus_ID_Hint = new javax.swing.JLabel();
        ...
        btnThem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Actions-user-group-new-icon.png"))); // NOI18N
        btnThem.setText("Add");
        ...
        txt_TenNKH.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jPanel1.add(txt_TenNKH);
        txt_TenNKH.setBounds(200, 110, 430, 30);

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel4.setText("Customer Type Name*");
        jPanel1.add(jLabel4);
        ...
        jLabel8.setText("Customer Type No.*");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(40, 50, 150, 17);

        txt_Ma_NKH.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jPanel1.add(txt_Ma_NKH);
        txt_Ma_NKH.setBounds(200, 42, 430, 30);
        ...
        jLabel12.setText("Customer Type No.");

        txt_Search_Ma_NKH.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N

        jLabel13.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel13.setText("Customer Type Name");

        txt_Search_Ten_NKH.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        lbl_MaNKH_Search_Hint.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        lbl_MaNKH_Search_Hint.setForeground(new java.awt.Color(204, 0, 0));
        lbl_MaNKH_Search_Hint.setText("  Invalid!");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(txt_Search_Ten_NKH))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel12)
                        .addGap(33, 33, 33)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(lbl_MaNKH_Search_Hint, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(txt_Search_Ma_NKH))))
                .addContainerGap())
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(txt_Search_Ma_NKH, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbl_MaNKH_Search_Hint, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(29, 29, 29)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_Search_Ten_NKH, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        lbl_Cus_ID_Hint.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        lbl_Cus_ID_Hint.setForeground(new java.awt.Color(204, 51, 0));
        lbl_Cus_ID_Hint.setText("  Invalid!");
        jPanel1.add(lbl_Cus_ID_Hint);
        lbl_Cus_ID_Hint.setBounds(200, 80, 100, 20);
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Customer Type List", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
    ...
    private void tab_KhachHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tab_KhachHangMouseClicked
        lbl_Cus_ID_Hint.setVisible(false);
        lbl_MaNKH_Search_Hint.setVisible(false);
        txt_Search_Ma_NKH.setText("");
        txt_Search_Ten_NKH.setText("");
        int row = tab_KhachHang.getSelectedRow();
        Integer maNhomKhachHang = (Integer) tab_KhachHang.getValueAt(row, 0);
        String tenNKH = (String) tab_KhachHang.getValueAt(row, 1);
        String moTa = (String) tab_KhachHang.getValueAt(row, 2);
        txt_Ma_NKH.setText(maNhomKhachHang.toString());
        txt_TenNKH.setText(tenNKH);
        tar_Mota.setText(moTa);
        txt_Ma_NKH.setEnabled(false);
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if (txt_Search_Ma_NKH.getText().trim().equals("") && txt_Search_Ten_NKH.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(this, "Enter information into the search box!");
            return;
        }
        if (!txt_Search_Ma_NKH.getText().trim().equals("")) {
            while (true) {
                try {
                    Integer.parseInt(txt_Search_Ma_NKH.getText().trim());
                    lbl_MaNKH_Search_Hint.setVisible(false);
                    break;
                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(this, "Invalid!! \n"
                            + "Some fields are not allowed to contain letters or special characters");
                    lbl_MaNKH_Search_Hint.setVisible(true);
                    return;
                }
            }
        }
        if (!txt_Search_Ma_NKH.getText().trim().equals("")) {
            nkh.setMaNhomKH(Integer.parseInt(txt_Search_Ma_NKH.getText().trim()));
        }
        if (!txt_Search_Ten_NKH.getText().trim().equals("")) {
            nkh.setTenNhomKH(txt_Search_Ten_NKH.getText().trim());
        }
        List<NhomKhachHang> nhomKhachHangList = nhomKhachHangDAO.search(nkh);
        for (NhomKhachHang nkhh : nhomKhachHangList) {
            Vector vector = new Vector();
            vector.add(nkhh.getMaNhomKH());
            vector.add(nkhh.getTenNhomKH());
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        Integer maNhomKhachHang = (Integer) tab_KhachHang.getValueAt(row, 0);
        if (KhachHangDAO.getListMaNhomKhachHang().contains(maNhomKhachHang)) {
            JOptionPane.showMessageDialog(this, "Unable to remove this customer type information\n"
                    + "Customer type information is being used!");
            return;
        }
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                NhomKhachHangDAO NKH_DAO = new NhomKhachHangDAO();
                NhomKhachHang nkh = new NhomKhachHang(maNhomKhachHang);
                NKH_DAO.delete(nkh);
                xoaTrang();
                loadDuLieuLenLuoi();
                JOptionPane.showMessageDialog(this, "Customer type information removed !");
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(FormNhomKhachHang.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            if (txt_TenNKH.getText().isEmpty() || txt_Ma_NKH.getText().isEmpty()) {
            ...
            while (true) {
                try {
                    Integer.parseInt(txt_Ma_NKH.getText().trim());
                    lbl_Cus_ID_Hint.setVisible(false);
                    break;
                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(this, "Invalid!! \n"
                            + "Some fields are not allowed to contain letters or special characters");
                    lbl_Cus_ID_Hint.setVisible(true);
                    return;
                }
            }
            NhomKhachHangDAO nhomKhachHangDAO = new NhomKhachHangDAO();
            if (nhomKhachHangDAO.getListMaNhomKhachHang().contains(Integer.parseInt(txt_Ma_NKH.getText().trim()))) {
                JOptionPane.showMessageDialog(this, "Customer type ID already exists!\n"
                        + "Re-Enter the customer type ID!!");
                txt_Ma_NKH.setText("");
                return;
            }
            //lấy giá trị nhập trên form truyền vào đôi tượng
            NhomKhachHang nkh = new NhomKhachHang();
            nkh.setMaNhomKH(Integer.parseInt(txt_Ma_NKH.getText().trim()));
            nkh.setTenNhomKH(txt_TenNKH.getText());
            nkh.setMoTa(tar_Mota.getText());
            //thực hiện thêm vào DB
            nhomKhachHangDAO.insert(nkh);
            ...
            JOptionPane.showMessageDialog(this, "Successfully add new Customers Type !");
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FormNhomKhachHang.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(FormNhomKhachHang.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        int row = tab_KhachHang.getSelectedRow();
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "Select one Customer Type before updating!");
            return;
        }
        try {
            //kiêm tra các thông tin bắt buộc nhập là quyền và tên vai trò
            ...
            nkh.setMoTa(tar_Mota.getText());
            //thực hiện thêm vào DB
            nhomKhachHangDAO.update(nkh);
            //nếu thành công thì thông báo
            JOptionPane.showMessageDialog(this, "Customer Type information updated successfully !");
            //reset form
            xoaTrang();
            //load lại dữ liệu lên lưới
            loadDuLieuLenLuoi();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormNhomKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FormNhomKhachHang().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(FormNhomKhachHang.class.getName()).log(Level.SEVERE, null, ex);
                } catch (SQLException ex) {
                    Logger.getLogger(FormNhomKhachHang.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lbl_Cus_ID_Hint;
    private javax.swing.JLabel lbl_MaNKH_Search_Hint;
    private javax.swing.JTable tab_KhachHang;
    private javax.swing.JTextArea tar_Mota;
    private javax.swing.JTextField txt_Ma_NKH;
    private javax.swing.JTextField txt_Search_Ma_NKH;
    private javax.swing.JTextField txt_Search_Ten_NKH;
    private javax.swing.JTextField txt_TenNKH;
    // End of variables declaration//GEN-END:variables

    public boolean soSanh(int row) {
        Integer maNhomKhachHang = (Integer) tab_KhachHang.getValueAt(row, 0);
        NhomKhachHang nkh = (new NhomKhachHangDAO()).getNKHByID(maNhomKhachHang);
        String tenNKH = txt_TenNKH.getText().trim();
        Integer maNKH = txt_Ma_NKH.getText().trim().equals(nkh.getMaNhomKH().toString())
                ? Integer.parseInt(txt_Ma_NKH.getText().trim()) : (new Random()).nextInt();
        String moTa = tar_Mota.getText().trim();
        if (nkh.getTenNhomKH().trim().equals(tenNKH) && nkh.getMaNhomKH().equals(maNKH) && nkh.getMoTa().trim().equals(moTa)) {
            return true;
        }
        return false;
    }
